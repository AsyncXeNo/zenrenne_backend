...
from api.models import CarModel, Make
...
class Command(BaseCommand):
    help = 'Add submodels to the CarModel table with their parent as models'
    ...
    def handle(self, *args, **kwargs):
        for make_name, model_name, submodel_name in DATA:
            ...
            try:
                ...
                # Add submodels (children of the model)
                ...
                self.stdout.write(self.style.SUCCESS(f'Added submodel {submodel} to parent {model_name}'))

            except CarModel.DoesNotExist:
                self.stdout.write(self.style.ERROR(f'Model {model_name} not found in the database'))

        self.stdout.write(self.style.SUCCESS('Submodel addition complete'))
